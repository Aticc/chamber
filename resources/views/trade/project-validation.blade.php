...
<div class="hero-content">
    ...
    <h1 class="headline fade-up revealed">Project <span style="color: #17015e;">Validation</span></h1>
...
<style>
  ...
  @media (max-width: 768px) {
    ...
    .validation-step { flex-direction: column; text-align: center; align-items: center; }
