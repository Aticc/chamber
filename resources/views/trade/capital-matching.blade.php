...
<div class="subpage-hero">
  <div class="subpage-hero-content">
    <div class="breadcrumb">Home / Trade & Investment / Capital Matching</div>
    <h1>Capital Matching</h1>
    <p>Aligning institutional mandates with verified opportunities.</p>
  </div>
</div>
    ...
    <div class="content-split">
      <div class="content-left">
        ...
        <ul class="feature-list">
          <li><strong>Investor Alignment:</strong> Matching institutional mandates with appropriate opportunities</li>
          <li><strong>Due Diligence Support:</strong> Verification and validation of investment opportunities</li>
          <li><strong>Capital Deployment:</strong> Structured pathways for institutional capital entry</li>
          <li><strong>Ongoing Oversight:</strong> Monitoring and reporting on capital deployment</li>
        </ul>
      </div>
