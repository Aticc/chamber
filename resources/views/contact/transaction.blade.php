...
<div id="hero" class="hero-section" style="background-image: url('{{ asset('assets/images/ATICC image .png') }}'); background-position: 60% center;">
  <div class="hero-content">
    ...
    <div class="body-text fade-up delay-2 revealed">Submit trade transactions, capital deployment requests, and investment facilitation inquiries.</div>
  </div>
</div>
    ...
    <div class="contact-form-wrapper" style="max-width: 800px; margin: 50px auto 0; background: white; border-radius: 24px; padding: 50px; box-shadow: 0 4px 20px rgba(0,0,0,0.05);">
      <form action="{{ route('contact.send') }}" method="POST">
        ...
        <div class="form-group" style="margin-bottom: 25px;">
          <label style="display: block; font-size: 13px; font-weight: 600;">Transaction Reference (if any)</label>
          <input type="text" name="transaction_ref" class="aticc-input-field">
        </div>

        <div class="form-group" style="margin-bottom: 25px;">
          <label style="display: block; font-size: 13px; font-weight: 600;">Submitting Entity <span style="color: #C62828;">*</span></label>
          <input type="text" name="institution" class="aticc-input-field" required>
        </div>

        <div class="form-group" style="margin-bottom: 25px;">
          <label style="display: block; font-size: 13px; font-weight: 600;">Authorized Representative <span style="color: #C62828;">*</span></label>
        ...
        <div class="form-group" style="margin-bottom: 25px;">
          <label style="display: block; font-size: 13px; font-weight: 600;">Transaction Type</label>
        ...
        <div class="form-group" style="margin-bottom: 25px;">
          <label style="display: block; font-size: 13px; font-weight: 600;">Transaction Value (USD)</label>
          <input type="text" name="transaction_value" class="aticc-input-field">
        </div>

        <div class="form-group" style="margin-bottom: 25px;">
          <label style="display: block; font-size: 13px; font-weight: 600;">Transaction Details <span style="color: #C62828;">*</span></label>
        ...
        <div class="legal-disclosure" style="border: 1px solid #D9DEE7; background-color: #F7F7F5; border-radius: 16px; padding: 24px; margin: 32px 0;">
          <h4 style="font-size: 11px; font-weight: 700; color: #041931;">CONFIDENTIALITY NOTICE</h4>
          <p style="font-size: 12px; color: #5D6F7F;">All transaction submissions are handled with strict confidentiality and subject to ATICC verification protocols.</p>
        </div>

        <button type="submit" class="aticc-submit">SUBMIT TRANSACTION</button>
      </form>
    </div>
  </div>
</div>
